...
# FIRMA GENÉTICA para DEGs 
# 1.- DEA gleason medio-bajo vs gleason alto
...
# 2.- Dividimos los datos (al azar) para generar grupo entrenamiento (2/3), y grupo validación (1/3)
...
dim(glmnet_datos)
#View(glmnet_datos)
#as.factor(glmnet_datos$G)
xtabs(~ G + gleason, tabla_final)
set.seed(7)
